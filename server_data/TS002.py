...
def authenticate(client):
    ...
    try:
        ...
        # *** FIX: Use getpass.getpass() for hidden input ***
...
def main():
    global IP, ADDR  # Need to declare these global to modify them

    # *** FIX: Get IP first and update ADDR ***
    ...
    try:
        ...
        while True:
            ...
            # Note: The SHUTDOWN command is implicitly available for the 'admin' user
            # but is not displayed in the menu to restrict general user knowledge.
